							...
							<div class="mb-3">
								...
								@if($gallery->image)
									<div class="mb-2">
										...
										<img src="{{ asset('storage/' . $gallery->image) }}" alt="Current image" class="img-thumbnail d-block mt-1" style="max-width: 200px; max-height: 150px;">
									</div>
								@endif
							...
							<div class="mb-3">
								...
								@if($gallery->thumbnail)
									<div class="mb-2">
										...
										<img src="{{ asset('storage/' . $gallery->thumbnail) }}" alt="Current thumbnail" class="img-thumbnail d-block mt-1" style="max-width: 150px; max-height: 100px;">
									</div>
								@endif
						...
						<div class="col-md-4">
							<div class="mb-3">
								...
								<select class="form-select @error('category') is-invalid @enderror" id="category" name="category" required>
									...
									<option value="kegiatan-belajar" {{ old('category', $gallery->category) == 'kegiatan-belajar' ? 'selected' : '' }}>Kegiatan Belajar</option>
									<option value="ekstrakurikuler" {{ old('category', $gallery->category) == 'ekstrakurikuler' ? 'selected' : '' }}>Ekstrakurikuler</option>
									<option value="acara-sekolah" {{ old('category', $gallery->category) == 'acara-sekolah' ? 'selected' : '' }}>Acara Sekolah</option>
