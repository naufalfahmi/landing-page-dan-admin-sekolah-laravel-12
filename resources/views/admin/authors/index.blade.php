		...
		<div class="card overflow-hidden">
			<div class="card-body">
				<div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3">
					<h6 class="card-title mb-0">Kelola Penulis</h6>
					<div class="dropdown">
						<button class="btn p-0" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<i class="icon-lg text-muted pb-3px" data-feather="more-horizontal"></i>
						</button>
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
							<a class="dropdown-item d-flex align-items-center" href="{{ route('admin.authors.create') }}"><i data-feather="plus" class="icon-sm me-2"></i> <span class="">Tambah Penulis</span></a>
						</div>
					</div>
				</div>
					...
					<table id="dataTableExample" class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<span class="badge bg-primary">{{ $author->articles_count }}</span>
								</td>
								<td>
									@if($author->is_active)
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
											<a class="dropdown-item d-flex align-items-center" href="{{ route('admin.authors.show', $author) }}"><i data-feather="eye" class="icon-sm me-2"></i> <span class="">Lihat</span></a>
											...
											<form action="{{ route('admin.authors.destroy', $author) }}" method="POST" class="d-inline">
												@csrf
												@method('DELETE')
												<button type="submit" class="dropdown-item d-flex align-items-center text-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus penulis ini?')">
