				...
				<div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3">
					...
					<div class="dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
							<a class="dropdown-item d-flex align-items-center" href="{{ route('admin.categories.create') }}"><i data-feather="plus" class="icon-sm me-2"></i> <span class="">Tambah Kategori</span></a>
						</div>
					</div>
				</div>
				<div class="row align-items-start">
					<div class="col-md-7">
						<p class="text-muted tx-13 mb-3 mb-md-0">Kelola semua kategori artikel Portal Islam. Anda dapat menambah, mengedit, atau menghapus kategori.</p>
					</div>
					<div class="col-md-5 d-flex justify-content-md-end">
						<a href="{{ route('admin.categories.create') }}" class="btn btn-primary mb-3 mb-md-0">
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
											<a class="dropdown-item d-flex align-items-center" href="{{ route('admin.categories.show', $category) }}"><i data-feather="eye" class="icon-sm me-2"></i> <span class="">Lihat</span></a>
