		...
		<div class="card overflow-hidden">
			<div class="card-body">
				<div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3">
					<h6 class="card-title mb-0">Tambah Kategori Galeri</h6>
					<div class="dropdown">
				...
				<div class="row align-items-start">
					<div class="col-md-7">
						<p class="text-muted tx-13 mb-3 mb-md-0">Buat kategori galeri baru untuk mengorganisir foto-foto di SMPIT Al-Itqon.</p>
					</div>
