					...
					<div class="row">
						<div class="col-md-8">
							...
							<div class="mb-3">
								...
								<input type="text" class="form-control @error('tags') is-invalid @enderror" id="tags" name="tags" value="{{ old('tags') ? implode(', ', old('tags')) : '' }}" placeholder="Masukkan tag, pisahkan dengan koma (contoh: motivasi, islami, siswa)">
